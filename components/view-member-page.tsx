...
export function ViewMemberPageComponent() {
        ...
        <header className="mb-8">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-4">
              ...
              <button className="bg-gradient-to-r from-purple-500 to-purple-700 text-white font-bold py-2 px-4 rounded-full flex items-center transition duration-300 hover:from-purple-600 hover:to-purple-800">
